...
import { FaCity, FaCrown, FaGem, FaHome, FaBuilding, FaHotel } from 'react-icons/fa';
...
const ViewOwnerDetailModal = ({ owner, show, onClose, onEdit, onDelete }) => {
  ...
  const planConfig = PLAN_TYPES[owner.subscriptionPlan] || PLAN_TYPES['Free'];
...
const OwnerPlans = () => {
  ...
  const [stats, setStats] = useState({ total: 0, Free: 0, Silver: 0, Gold: 0, Platinum: 0 });
  ...
  const generateMockOwners = useCallback(() => {
    ...
    for (let i = 1; i <= 60; i++) {
      ...
      list.push({
        id: `own_${i}`,
        ownerId: `OWN-${String(i).padStart(4, '0')}`,
        name,
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#5A7D78] flex items-center gap-2 flex-wrap">
              <span>Free, Silver, Gold &amp; Platinum owner subscriptions</span>
