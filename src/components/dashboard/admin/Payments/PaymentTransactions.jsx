...
// ============================================================
const ViewTransactionDetailModal = ({ transaction, show, onClose, onEdit, onDelete }) => {
...
const EditTransactionModal = ({ transaction, show, onClose, onSave }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    paymentStatus: '', refundStatus: '', description: ''
  });
...
const PaymentTransactions = () => {
  ...
  const generateMockTransactions = useCallback(() => {
    ...
    const refundStatuses = ALL_REFUND_STATUSES;
    ...
    for (let i = 1; i <= 120; i++) {
      ...
      // Spread dates over the last 90 days; force some onto today
      let payDate;
      if (i % 12 === 0) {
  ...
  }, [transactions, searchQuery, activeStatus, activeMethod, activeGateway, activeUserType, activePurpose, activePropertyType, activeRefundStatus, sortField, sortDirection]);
    ...
    <div className="space-y-6 p-4 lg:p-6 bg-[#F8FAF9] min-h-screen">
      ...
      <div className="relative">
        {loading ? (
          ...
          /* ============ LIST VIEW — proper single-line table ============ */
