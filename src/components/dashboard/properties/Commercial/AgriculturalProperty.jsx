...
const AgriculturalProperty = () => {
  ...
  const normalizeProperties = useCallback((list) => {
    ...
    return list.map(p => ({
      ...p,
      propertyType: AGRICULTURAL_PROPERTY_TYPE.label
    }));
  }, []);
  ...
  const generateMockProperties = useCallback(() => {
    const propertyTitles = [
      'Green Valley Agricultural Commercial Plot', 'Golden Harvest Farmland Property', 'Riverside Agricultural Plot',
      'Silverline Farmland Property', 'Metro Agricultural Commercial Plot', 'Crown Farmland Property',
      'Sunrise Agricultural Plot', 'Palm Grove Farmland Property', 'Fortune Agricultural Commercial Plot',
      'Emerald Farmland Property', 'Pinnacle Agricultural Plot', 'Aster Farmland Property',
      'Zenith Agricultural Commercial Plot', 'Orion Farmland Property', 'Regal Agricultural Plot',
      'Meridian Farmland Property', 'Phoenix Agricultural Commercial Plot', 'Harvest Moon Farmland Property'
    ];
    ...
    for (let i = 1; i <= 40; i++) {
      ...
      propertiesList.push({
        id: `ag_${i}`,
        propertyId: `AG-${String(i).padStart(4, '0')}`,
        propertyTitle: propertyTitles[Math.floor(Math.random() * propertyTitles.length)],
        propertyType: AGRICULTURAL_PROPERTY_TYPE.label,
        listingType,
        description: `A well-located agricultural commercial property with fertile land and strong irrigation access, available for ${listingType.toLowerCase()}.`,
