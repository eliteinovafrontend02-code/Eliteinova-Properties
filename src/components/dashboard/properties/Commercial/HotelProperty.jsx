...
const HotelProperty = () => {
  ...
  const normalizeProperties = useCallback((list) => {
    ...
    return list.map(p => ({
      ...p,
      propertyType: HOTEL_PROPERTY_TYPE.label
    }));
  }, []);
  ...
  const generateMockProperties = useCallback(() => {
    const propertyTitles = [
      'Palm Court Resort Property', 'Golden Tulip Hotel Property', 'Riverside Lodge Property',
      'Silverline Resort Property', 'Metro Grand Hotel Property', 'Crown Lodge Property',
      'Sunrise Resort Property', 'Union Square Hotel Property', 'Palm Grove Lodge Property',
      'Fortune Resort Property', 'Emerald Hotel Property', 'Pinnacle Lodge Property',
      'Aster Resort Property', 'Zenith Hotel Property', 'Orion Lodge Property',
      'Regal Resort Property', 'Meridian Hotel Property', 'Galaxy Lodge Property'
    ];
    ...
    for (let i = 1; i <= 40; i++) {
      ...
      propertiesList.push({
        id: `hp_${i}`,
        propertyId: `HP-${String(i).padStart(4, '0')}`,
        propertyTitle: propertyTitles[Math.floor(Math.random() * propertyTitles.length)],
        propertyType: HOTEL_PROPERTY_TYPE.label,
        listingType,
        description: `A well-located hotel / lodge / resort property with premium guest facilities and strong hospitality infrastructure, available for ${listingType.toLowerCase()}.`,
