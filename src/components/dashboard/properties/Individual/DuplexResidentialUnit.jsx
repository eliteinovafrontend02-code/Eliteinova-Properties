...
const DuplexResidentialUnit = () => {
  ...
  const generateMockProperties = useCallback(() => {
    const propertyTitles = [
      'Green Valley Duplex', 'Lakeside Duplex Residence', 'Sunrise Twin Duplex', 'Royal Palm Duplex',
      'Silver Oak Duplex', 'Golden Meadows Duplex', 'Cedar Woods Duplex', 'Maple Leaf Duplex',
      'Orchid Garden Duplex', 'Tulip Duplex Residence', 'Lotus Duplex Home', 'Jasmine Duplex Unit',
      'Emerald Greens Duplex', 'Pearl Residency Duplex', 'Ruby Enclave Duplex', 'Sapphire Duplex Unit'
    ];
    ...
    for (let i = 1; i <= 40; i++) {
      ...
      propertiesList.push({
        id: `dru_${i}`,
        propertyId: `DRU-${String(i).padStart(4, '0')}`,
        propertyTitle: propertyTitles[Math.floor(Math.random() * propertyTitles.length)],
        propertyType: DUPLEX_TYPE.label,
        listingType,
        description: `A well-maintained duplex residential unit with good ventilation and prime connectivity, available for ${listingType.toLowerCase()}.`,
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#5A7D78] flex items-center gap-2 flex-wrap">
              <span>All Duplex Residential Unit listings across Buy, Rent, Sell &amp; Lease</span>
